...
using TransportControl.Droid.Dependencies;
using Xamarin.Forms;

[assembly: Dependency(typeof(ThemeChangedListener))]
namespace TransportControl.Droid.Dependencies
{
    public class ThemeChangedListener : IThemeChangedListener
    {
        public void OnThemeChanged(ThemeManager.ThemeType theme)
        {
